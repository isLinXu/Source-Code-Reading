...
ID_SHARD = int(sys.argv[1])
ID_SHARD_RELATIVE = ID_SHARD + 200

PATH_S3_RAW_LAION_SHARD = f"s3://m4-datasets/LAION_data/laion_raw_hf_dataset_1_4/{ID_SHARD}/*"
PATH_SAVE_DISK_TMP_FILES = f"/scratch/storage_hugo_{ID_SHARD}/"
...
PATH_SAVE_S3_LAION_COCO_SHARD = f"s3://m4-datasets/LAION_data/laion_coco_dataset/{ID_SHARD_RELATIVE}/"
