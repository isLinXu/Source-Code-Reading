...
NAME_DS_PUSH_HUB = "HuggingFaceM4/AI2D_2"
...
ds = load_dataset("HuggingFaceM4/AI2D_2")
def filter_ds(example):
    question = example["question"].lower()
    if ("a\n" in question) or ("b\n" in question) or ("c\n" in question) or ("d\n" in question):
        return False
    return True
ds_ = ds.filter(filter_ds, num_proc=8)  # 1840 examples
ds_.push_to_hub("HuggingFaceM4/AI2D_3")
"""
