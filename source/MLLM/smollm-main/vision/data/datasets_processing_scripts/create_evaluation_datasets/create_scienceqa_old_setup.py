...
ds = load_dataset(
    "/Users/leotronchon/Documents/Github/m4/datasets_processing_scripts/create_evaluation_datasets/ScienceQA/scienceqa_old_setup.py",
    use_auth_token=True,
)
...
repo_id = "HuggingFaceM4/ScienceQA_support_query_sets_old_setup"
